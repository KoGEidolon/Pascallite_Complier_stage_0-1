; Huan Tran & Duc Huy Nguyen       Wed Nov 18 03:46:23 2020
%INCLUDE "Along32.inc"
...
_start:                                 
        ...
        jl      .L0                     ; if z < w then jump to set eax to TRUE
...
.L1:                                    
        ...
        jge     .L2                     ; if 3 >= z then jump to set eax to TRUE
        mov     eax,[FALSE]             ; else set eax to FALSE
...
.L3:                                    
        ...
        jl      .L4                     ; if 4 < w then jump to set eax to TRUE
        mov     eax,[FALSE]             ; else set eax to FALSE
